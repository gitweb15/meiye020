<template>
	...
	<div id="yuyue">
		...
		<div class="yuyue">
			<div class="one">
				<router-link to="/meitiDizhi" tag="div" class="two">
					<span style="width: 10%;float: left;">
						<img class="img" src="../../../public/image/u582.png" style="width: 24px;margin: 7px 0px 0px 5px;">
					</span>
					<div style="width: 89%;float: right;"><span class="span">选择服务地点</span>
						<img src="../../../public/image/u155.png" class="jiantou" /></div>
				</router-link>
			</div>
			<div class="one">
				<div class="two">
			...
			<div class="one">
				<router-link to="/meitiXuanze" tag="div" class="two">
					<span style="width: 10%;float: left;">
						<img class="img" src="../../../public/image/u680.png" style="width: 30px;margin: 7px 0px 0px 2px;">
					</span>
					<div style="width: 89%;float: right;"><span class="span">系统推荐</span>
						<img src="../../../public/image/u155.png" class="jiantou" />
						<span class="huise">手动选择</span></div>
				</router-link>
			</div>
			...
			<van-button type="default" class="anniu" is-link url="/meitiZhifu">支付宝支付</van-button>
			<van-button type="default" class="anniu" is-link url="/meitiZhifu">微信支付</van-button>
		</div>
	</div>
</template>
