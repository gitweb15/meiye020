<template>
	...
	<div id="xiangmu">
		...
		<div class="xiangmu">
			...
			<van-button type="default" class="anniu" is-link url="/meifuYuyue">立即预约</van-button>
		</div>
	</div>
</template>
...
<script>
	...
	export default {
		...
		data() {
			return {
				tupian: '/img/服务.236c3fcf.png', //服务项目图片
				jiage: '99.0', //价格
				time: '60', //时间
				jieshao: '项目服务内容简介，最多显示2行，多余省略项目服务内容简介，最多显示2行，多余省略', //项目服务内容简介
				tupian1: '../img/美容师.76d81d89.jpg', //美体师图片
				name: '美体师名称', //美体师姓名
				pingfen: '守时5.0 专业5.0 沟通5.0评分' //评分
			}
		}
	}
</script>
